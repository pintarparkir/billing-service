...
type QrisIntent struct {
	...
	SnapToken     string                 `protobuf:"bytes,3,opt,name=snap_token,json=snapToken,proto3" json:"snap_token,omitempty"`       // SNAP token from Midtrans
	RedirectUrl   string                 `protobuf:"bytes,4,opt,name=redirect_url,json=redirectUrl,proto3" json:"redirect_url,omitempty"` // SNAP redirect URL for checkout
	PgReference   string                 `protobuf:"bytes,5,opt,name=pg_reference,json=pgReference,proto3" json:"pg_reference,omitempty"`
...
func (x *QrisIntent) GetSnapToken() string {
	if x != nil {
		return x.SnapToken
	}
	return ""
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\n" +
	"amount_idr\x18\x02 \x01(\x03R\tamountIdr\"\xee\x01\n" +
	"\n" +
	"QrisIntent\x12\x1d\n" +
	"\n" +
	"payment_id\x18\x01 \x01(\tR\tpaymentId\x12!\n" +
	"\fqris_payload\x18\x02 \x01(\tR\vqrisPayload\x12\x1d\n" +
	"\n" +
	"snap_token\x18\x03 \x01(\tR\tsnapToken\x12!\n" +
	"\fredirect_url\x18\x04 \x01(\tR\vredirectUrl\x12!\n" +
	"\fpg_reference\x18\x05 \x01(\tR\vpgReference\x129\n" +
	"\n" +
